            ...
            <>
                    <div className="product-card">
                        <div className="product-card__image-box">
                            <img src={item.image} alt="shoes" className="product-card__image img-fluid" />
                        </div>
                        <div className="product-card__info">
                            ...
                            <a href="#" className="product-card__btn btn btn-sm btn-outline-dark"><i className="fa fa-eye" /> Quick View</a>
                        </div>
                </div>
